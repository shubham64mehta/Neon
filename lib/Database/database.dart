...
class _SolidColorState extends State<SolidColor> with SingleTickerProviderStateMixin {
               ...
               /* showDialog(context: context,
                builder: (BuildContext context){
                  return AlertDialog(
                    ...
                    content: Text("Convert it into gradient",
...
Future<void> add(var color1 ,var color2) async{
  ...
  DatabaseReference  _color2 = database.reference().child("Gradient").child(uuid);

        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: ExactAssetImage("images/tiles.jpg"),
              fit: BoxFit.fill,
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    "Neon is a brand new way of sharing",
                    style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 22,
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 24.0),
                  child: Text(
                    "your captured colors and gradients",
                    style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 22,
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  signInWithGoogle().whenComplete(() async {
                    ...
                    user1 = pref1.get("alreadyregistered");
                  });
                },
              ),
            ),
...
Future<void> add() async {
  ...
  DatabaseReference _color2 =
      database.reference().child("Profiles").child(user1);
  ...
  _color2.set(
      {"Name": name, "Image": imageUrl, "Uid": user1, "bool": true.toString()});
}

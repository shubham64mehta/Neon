        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                  "Tap the banner above to see available tripping options",
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Divider(color: Colors.grey, indent: 35),
                      Row(
                        children: <Widget>[
                          SizedBox(width: 10),
                          Icon(
                            Typicons.social_tumbler_circular,
                            color: Colors.blue,
                          ),
                          SizedBox(width: 35),
                          Text(
              ...
              child: RaisedButton(
                ...
                onPressed: () async {
                  ...
                  Navigator.of(context).pushNamedAndRemoveUntil(
                      '/Home4', (Route<dynamic> route) => false);
                  SharedPreferences prefs =
                      await SharedPreferences.getInstance();
                  prefs.remove('alreadyregistered');
                  prefs.remove('name');
                  prefs.remove('email');
                  prefs.remove('image');
                  // Navigator.of(context).pushNamedAndRemoveUntil('/Home4',ModalRoute.withName('/Home7'));
                },
              ),
            )
          ],
